...
6. Export your library or collection from Zotero as .csv file. Remember to check the "add notes" option to add excerpts.
7. Copy the content of the CSV file in assets/data/books_zotero.csv
8. Run ```python3 assets/env/src/morel-generate.py``` 